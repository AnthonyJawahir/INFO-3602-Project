...
/* --------------------------------- Breadcrumbs --------------------------------------*/
   ...
   function custom_breadcrumbs_post() {
    ...
    if (is_category() || is_single()) {
        ...
        the_category(' </span><span class="separator"> > </span> ');
        if (is_single()) {
            echo ' <span class="separator"> > </span> ';
            the_title();
        }
        ...
        if ($post->post_parent) {
            ...
            foreach ($anc as $ancestor) {
                $output = '<span class="separator"> > </span><a href="' . get_permalink($ancestor) . '" title="' . get_the_title($ancestor) . '">' . get_the_title($ancestor) . '</a>' . $output;
            }
            echo $output;
            echo ' <span class="separator"> > </span> ';
            the_title();
...
function custom_login_message() {
    return '<p class="message">Welcome to the SmartPhoneInsider site! <br>Your smartphone companion</p>';
}
add_filter( 'login_message', 'custom_login_message' );

add_action( 'login_form', 'add_signup_button_to_login_form' );

function add_signup_button_to_login_form() {
    echo '<a href="http://smartphone-insider.infinityfreeapp.com/wp-login.php?action=register" class="signup-button">Sign Up</a>';
}
